package com.eclipse.gapps.settings;
 ...
 * supported: "eclipse", and "system". Defaults to "eclipse" if none is specified. Note that there is no namespace on this attribute.
 * </ul>
 * <p/>
...
public class BaseSetting extends LinearLayout {
    ...
    /**
     * @return the table which the setting will be saved to. Currently only 'eclipse' and 'system' are supported
     */
