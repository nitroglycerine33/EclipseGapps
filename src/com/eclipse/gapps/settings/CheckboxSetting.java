 ...
 * <li>eclipse:descriptionOn - a @string reference, which will be set as the summary when enabled.
 * <li>eclipse:descriptionOff - a @string reference, which will be set as the summary when disabled.
 * </ul>
 */
